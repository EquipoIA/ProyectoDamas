...
def minimaxRed(position, depth, max_player,alpha,beta):
    ...
    if max_player:#si estamos buscando maximizar el valor
        ...
        for move in get_all_moves(position, RED): #recorre los hijos del nodo en el que estamos
            evaluation = minimaxRed(move, depth-1, False,alpha, beta)[0]
            if evaluation > value:
                value = evaluation
        ...
        for move in get_all_moves(position, BLUE):#recorre los hijos del nodo en el que estamos
            evaluation = minimaxRed(move, depth-1, True,alpha,beta)[0]
            if evaluation < value:
                value = evaluation
